...
export type WebdriverIoTestData = TestFile | TestCase;

export const testData = new WeakMap<vscode.TestItem, WebdriverIoTestData>();
...
function getWorkspaceTestPatterns() {
    ...
    const testFileGlobPattern = vscode.workspace.getConfiguration('wdio-test-explorer').get('testFileGlobPattern') as string;

	return vscode.workspace.workspaceFolders.map(workspaceFolder => ({
		workspaceFolder,
		pattern: new vscode.RelativePattern(workspaceFolder, testFileGlobPattern),
	}));
}
